    ...
    return (
        <div className='app-container'>
            ...
            <div className='form'>
                ...
                {exercicioSelecionado && <button type="button" onClick={salvarExercicio}>Salvar Alterações</button>}
                {!exercicioSelecionado && <button type="button" onClick={cadastrarExercicio}>Cadastrar Exercício</button>}
            </div>
